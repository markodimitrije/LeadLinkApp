 ...
 *
 * To display the views, this overlay must be attached to DataCaptureView. This may be done either by creating it with overlayWithBarcodeTracking:forDataCaptureView: with a non-null view parameter or by passing this overlay to SDCDataCaptureView.addOverlay:.
 *
...
/**
 * Construct a new barcode tracking advanced overlay for the barcode tracking instance. The overlay is automatically added to the view.
 */
...
- (void)setOffset:(SDCPointWithUnit)offset
    forTrackedBarcode:(nonnull SDCTrackedBarcode *)trackedBarcode;
/**
 * Clear all the views for the currently tracked barcodes from this overlay.
 * This method is thread-safe, it can be called from any thread.
 */

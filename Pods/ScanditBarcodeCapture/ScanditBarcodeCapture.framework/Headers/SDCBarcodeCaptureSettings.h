...
/**
 * Holds all the barcode recognition related settings, such as enabled symbologies and search areas. To use the settings, they must be applied to a barcode capture instance using SDCBarcodeCapture.applySettings:completionHandler:.
 *
...
/**
 * Create new default settings instance. Recognition is setup for recognizing codes in the full image. Symbologies are all disabled. Before passing the settings to the SDCBarcodeCapture instance, make sure to enable the symbologies required by your application.
 */
...
/**
 * Defines the strategy with which to select one out of many visible barcodes. See Scan Area Guide. By default, this property is nil and code selection is disabled.
 */

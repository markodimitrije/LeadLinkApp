...
class StackViewToSwitchBtnsViewModelBinder: ViewStackerViewsToViewModelBinder {
    func hookUp(btnViews: [LabelBtnSwitchView], viewmodel: SwitchBtnsViewModel, bag: DisposeBag, selector: Selector? = nil) {

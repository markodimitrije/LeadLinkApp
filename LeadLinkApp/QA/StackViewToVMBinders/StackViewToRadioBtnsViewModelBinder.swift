...
class StackViewToRadioBtnsViewModelBinder: ViewStackerViewsToViewModelBinder {
    
    func hookUp(btnViews: [RadioBtnView], viewmodel: RadioViewModel, bag: DisposeBag, selector: Selector? = nil) {
